...
public class SeekBarPressure extends View {
    ...
    private float mTextWidth_Low ;
    private float mTextWidth_High ;
...
//        this.setBackgroundColor(Color.BLACK);
        ...
        notScrollBarBg = resources.getDrawable(R.mipmap.progress_bar);
        hasScrollBarBg = resources.getDrawable(R.mipmap.color_bar);
        mThumbLow = resources.getDrawable(R.mipmap.btn_white);
        mThumbHigh = resources.getDrawable(R.mipmap.btn_white);
...
//        int height = measureHeight(heightMeasureSpec);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        text_Paint.setTextSize(dp2px(18));
        ...
        //蓝色，中间部分会动
        hasScrollBarBg.setBounds((int)mOffsetLow, aaa+mScollBarHeight/4, (int)mOffsetHigh, bbb-mScollBarHeight/4);
        ...
        double progressLow = formatDouble((mOffsetLow - mThumbWidth / 2) * 180 / mDistance);
        double progressHigh = formatDouble((mOffsetHigh - mThumbWidth / 2) * 180 / mDistance);
        mTextWidth_Low = text_Paint.measureText((int) progressLow + "");
        mTextWidth_High = text_Paint.measureText((int) progressHigh + "");


//            Log.d(TAG, "onDraw-->mOffsetLow: " + mOffsetLow + "  mOffsetHigh: " + mOffsetHigh   + "  progressLow: " + progressLow + "  progressHigh: " + progressHigh);
        canvas.drawText((int) progressLow + "", (int)mOffsetLow  - mTextWidth_Low/2, getHeight()-Czsize, text_Paint);
        canvas.drawText((int) progressHigh + "", (int)mOffsetHigh - mTextWidth_High/2, getHeight()-Czsize, text_Paint);
